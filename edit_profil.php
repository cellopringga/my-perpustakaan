...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $cek_email = "SELECT id FROM users WHERE email = '$email' AND id != $user_id";
    $result_email = mysqli_query($conn, $cek_email);
    if (mysqli_num_rows($result_email) > 0) {
        $errors[] = "Email sudah digunakan oleh member lain";
    }
        ...
        <ul class="sidebar-menu">
            ...
            <li class="has-dropdown active open" id="dropdownProfil">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="edit_profil.php" style="color: #059669; font-weight: 700;">• Edit Profil</a></li>
        ...
        <div class="form-card">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="no_telepon" value="<?= htmlspecialchars($member['no_telepon'] ?? ''); ?>">
                </div>

                <div class="form-group">
                    <label><i class="fa-solid fa-location-dot"></i> Alamat</label>
                    <textarea name="alamat"><?= htmlspecialchars($member['alamat'] ?? ''); ?></textarea>
                </div>
